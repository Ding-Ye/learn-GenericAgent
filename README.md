...
| s10 | [s10-reflect](agents/s10-reflect) | 反射模式与自动调度 | `agentmain.py --reflect`, `reflect/scheduler.py` | ✅ |
| s_full | [集成](docs/zh/s_full-integration.md) | 把上面 10 节拼起来跑一条端到端 use case | `agentmain.py:GenericAgent` | ✅ |
| 附录 A | [自演化的本质](docs/zh/appendix-a-self-evolution.md) | "skill crystallization" 的心智模型 | README + memory/ | ✅ |
| 附录 B | [上游源码导读地图](docs/zh/appendix-b-upstream-map.md) | 文件级 → 课程节的对照表 | 全仓库 | ✅ |
